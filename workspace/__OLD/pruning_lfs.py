...
def prune_lfs(CHOSEN_DS = '', TARGETAUDIENCE = None, DOMAIN = None):
    ...
    for dataset in datasets:
        labels_simp_list.append(pickle.load(open("/workspace/datasets/__all_LFs/" + dataset + "-1249_simp_labels.pkl", "rb")))
        labels_src_list.append(pickle.load(open("/workspace/datasets/__all_LFs/" + dataset + "-1249_src_labels.pkl", "rb")))
    ...
    df_md.to_excel("/workspace/datasets/__all_LFs/prunings/" + str(datasets) + "_" + str(TARGETAUDIENCE) + "_" + str(DOMAIN) + "TEST_label_data.xlsx")  
